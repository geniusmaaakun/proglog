...
//muxはリスナーからの接続を受けつけ、設定されたルールに基づいてコネクションを選別する
...
func (a *Agent) setupLog() error {
	...
	//Raftコネクションの処理
	//分散かログのRaftが多重化リスナーを使うようにして、分散ログの設定と作成を行う
...
func (a *Agent) setupServer() error {
	...
	//RaftとgRPCを多重化し、Raftコネクション用のマッチャーを追加したので、他の全てのコネクションはgRPCコネクションに違いないことがわかる
...
//RAftのおかげで独自のレプリケーターは不要
//代わりにサーバーがクラスタに参加、離脱の処理が必要
